...
const benefits = [
    { text: "Competitive pricing and transparent quotes." },
    { text: "Guaranteed capacity and on-time delivery." },
    { text: "End-to-end visibility with real-time tracking." },
    { text: "Streamlined booking and freight management." },
    { text: "Dedicated support team for your shipments." },
];
